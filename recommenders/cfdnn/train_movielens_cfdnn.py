...
from lib.datasets import movielens
from lib.recommenders.cfdnn import model_cfdnn
from lib.utils import progress_mngr
from lib.utils import train_utils
...
def train_and_evaluate(config: ml_collections.ConfigDict):
  ...
  datasets = movielens.prepare_movielens_datasets(
